...
\`\`\``,
    ...
    {
      cppDeclaration:
        "vector<int> pairSumsToTarget(vector<int>& nums, int target)",
...
\`\`\``,
    ...
    {
      cppDeclaration: "int bestSingleTrade(vector<int>& prices)",
...
\`\`\``,
    ...
    {
      cppDeclaration: "bool hasAnyDuplicate(vector<int>& nums)",
      cppTypes: { params: ["int[]"], returns: "bool" },
    },
  ),
  p(
    "product-of-the-rest",
...
\`\`\``,
    ...
    {
      cppDeclaration: "vector<int> productOfTheRest(vector<int>& nums)",
      cppTypes: { params: ["int[]"], returns: "int[]" },
    },
  ),
  p(
...
\`\`\``,
    ...
    {
      cppDeclaration: "int largestRunSum(vector<int>& nums)",
      cppTypes: { params: ["int[]"], returns: "int" },
    },
  ),
  p(
...
\`\`\``,
    ...
    {
      cppDeclaration: "int largestRunProduct(vector<int>& nums)",
      cppTypes: { params: ["int[]"], returns: "int" },
    },
  ),
  p(
...
\`\`\``,
    ...
    {
      cppDeclaration: "int smallestInRotated(vector<int>& nums)",
      cppTypes: { params: ["int[]"], returns: "int" },
    },
  ),
  p(
...
\`\`\``,
    ...
    {
      cppDeclaration: "int searchRotatedSorted(vector<int>& nums, int target)",
      cppTypes: { params: ["int[]", "int"], returns: "int" },
    },
  ),
  p(
...
\`\`\``,
    ...
    {
      cppDeclaration:
        "vector<vector<int>> triplesSummingToZero(vector<int>& nums)",
      cppTypes: { params: ["int[]"], returns: "int[][]" },
    },
  ),
  p(
...
\`\`\``,
    ...
    {
      cppDeclaration: "int largestWaterContainer(vector<int>& heights)",
      cppTypes: { params: ["int[]"], returns: "int" },
    },
  ),
];
